                                    ...
                                    266 	.globl _ACC
                                    267 	.globl _PSW
                                    268 	.globl _EP2_buffer
                                    269 	.globl _EP1_buffer
                                    270 	.globl _EP0_buffer
                                    271 ;--------------------------------------------------------
      ...
      000000                        385 	.org 0x0000
                           ...
                           000090   515 _PP10	=	0x0090
                           000091   516 _PP11	=	0x0091
                           000092   517 _PP12	=	0x0092
                           000093   518 _PP13	=	0x0093
                           000094   519 _PP14	=	0x0094
                           000095   520 _PP15	=	0x0095
                           000096   521 _PP16	=	0x0096
                           000097   522 _PP17	=	0x0097
                           0000B0   523 _PP30	=	0x00b0
                           0000B1   524 _PP31	=	0x00b1
                           0000B2   525 _PP32	=	0x00b2
                           0000B3   526 _PP33	=	0x00b3
                           0000B4   527 _PP34	=	0x00b4
                           0000B5   528 _PP35	=	0x00b5
                           0000B6   529 _PP36	=	0x00b6
                           0000B7   530 _PP37	=	0x00b7
                                    531 ;--------------------------------------------------------
      ...
      000000                        535 	.ds 8
                                    536 ;--------------------------------------------------------
                                    537 ; overlayable bit register bank
                                    538 ;--------------------------------------------------------
                                    539 	.area BIT_BANK	(REL,OVR,DATA)
      000021                        540 bits:
      000021                        541 	.ds 1
                           008000   542 	b0 = bits[0]
                           008100   543 	b1 = bits[1]
                           008200   544 	b2 = bits[2]
                           008300   545 	b3 = bits[3]
                           008400   546 	b4 = bits[4]
                           008500   547 	b5 = bits[5]
                           008600   548 	b6 = bits[6]
                           008700   549 	b7 = bits[7]
                                    550 ;--------------------------------------------------------
                                    ...
                                    556 ;--------------------------------------------------------
                                    557 ;--------------------------------------------------------
                                    558 ; Stack segment in internal ram
                                    559 ;--------------------------------------------------------
                                    560 	.area SSEG
      000022                        561 __start__stack:
      000022                        562 	.ds	1
                                    563 
                                    564 ;--------------------------------------------------------
                                    ...
                                    581 ;--------------------------------------------------------
                                    582 ; uninitialized external ram data
                                    583 ;--------------------------------------------------------
                                    584 	.area XSEG    (XDATA)
                           000000   585 _EP0_buffer	=	0x0000
                           00000A   586 _EP1_buffer	=	0x000a
                           000014   587 _EP2_buffer	=	0x0014
                                    588 ;--------------------------------------------------------
                                    589 ; absolute external ram data
                                    590 ;--------------------------------------------------------
                                    591 	.area XABS    (ABS,XDATA)
                                    592 ;--------------------------------------------------------
                                    593 ; initialized external ram data
                                    594 ;--------------------------------------------------------
                                    595 	.area XISEG   (XDATA)
                                    596 	.area HOME    (CODE)
                                    ...
                                    605 	.area CSEG    (CODE)
                                    606 ;--------------------------------------------------------
                                    607 ; interrupt vector
                                    608 ;--------------------------------------------------------
                                    609 	.area HOME    (CODE)
      000000                        610 __interrupt_vect:
      000000 02 00 49         [24]  611 	ljmp	__sdcc_gsinit_startup
      000003 32               [24]  612 	reti
      000004                        613 	.ds	7
      00000B 32               [24]  614 	reti
      00000C                        615 	.ds	7
      000013 32               [24]  616 	reti
      000014                        617 	.ds	7
      00001B 32               [24]  618 	reti
      00001C                        619 	.ds	7
      000023 32               [24]  620 	reti
      000024                        621 	.ds	7
      00002B 32               [24]  622 	reti
      00002C                        623 	.ds	7
      000033 32               [24]  624 	reti
      000034                        625 	.ds	7
      00003B 32               [24]  626 	reti
      00003C                        627 	.ds	7
      000043 02 21 29         [24]  628 	ljmp	_USB_ISR
                                    629 ;--------------------------------------------------------
      ...
      0000B3 02 00 46         [24]  643 	ljmp	__sdcc_program_startup
                                    644 ;--------------------------------------------------------
                                    645 ; Home
                                    646 ;--------------------------------------------------------
                                    647 	.area HOME    (CODE)
                                    648 	.area HOME    (CODE)
      000046                        649 __sdcc_program_startup:
      000046 02 21 68         [24]  650 	ljmp	_main
                                    651 ;	return from main will return to caller
                                    652 ;--------------------------------------------------------
                                    653 ; code
                                    654 ;--------------------------------------------------------
                                    655 	.area CSEG    (CODE)
                                    656 ;------------------------------------------------------------
                                    657 ;Allocation info for local variables in function '__sdcc_external_startup'
                                    658 ;------------------------------------------------------------
                                    659 ;	main.c:19: unsigned char __sdcc_external_startup (void) __nonbanked {
                                    660 ;	-----------------------------------------
                                    661 ;	 function __sdcc_external_startup
                                    662 ;	-----------------------------------------
      002125                        663 ___sdcc_external_startup:
                           000007   664 	ar7 = 0x07
                           000006   665 	ar6 = 0x06
                           000005   666 	ar5 = 0x05
                           000004   667 	ar4 = 0x04
                           ...
                           000001   670 	ar1 = 0x01
                           000000   671 	ar0 = 0x00
                                    672 ;	main.c:20: return 0;
      002125 75 82 00         [24]  673 	mov	dpl,#0x00
                                    674 ;	main.c:21: }
      002128 22               [24]  675 	ret
                                    676 ;------------------------------------------------------------
                                    677 ;Allocation info for local variables in function 'USB_ISR'
                                    678 ;------------------------------------------------------------
                                    679 ;	main.c:24: void USB_ISR(void) __interrupt(INT_NO_USB) {
                                    680 ;	-----------------------------------------
                                    681 ;	 function USB_ISR
                                    682 ;	-----------------------------------------
      002129                        683 _USB_ISR:
      002129 C0 21            [24]  684 	push	bits
      00212B C0 E0            [24]  685 	push	acc
      00212D C0 F0            [24]  686 	push	b
      00212F C0 82            [24]  687 	push	dpl
      002131 C0 83            [24]  688 	push	dph
      002133 C0 07            [24]  689 	push	(0+7)
      002135 C0 06            [24]  690 	push	(0+6)
      002137 C0 05            [24]  691 	push	(0+5)
      002139 C0 04            [24]  692 	push	(0+4)
      00213B C0 03            [24]  693 	push	(0+3)
      00213D C0 02            [24]  694 	push	(0+2)
      00213F C0 01            [24]  695 	push	(0+1)
      002141 C0 00            [24]  696 	push	(0+0)
      002143 C0 D0            [24]  697 	push	psw
      002145 75 D0 00         [24]  698 	mov	psw,#0x00
                                    699 ;	main.c:25: USB_interrupt();
      002148 12 20 C1         [24]  700 	lcall	_USB_interrupt
                                    701 ;	main.c:26: }
      00214B D0 D0            [24]  702 	pop	psw
      00214D D0 00            [24]  703 	pop	(0+0)
      00214F D0 01            [24]  704 	pop	(0+1)
      002151 D0 02            [24]  705 	pop	(0+2)
      002153 D0 03            [24]  706 	pop	(0+3)
      002155 D0 04            [24]  707 	pop	(0+4)
      002157 D0 05            [24]  708 	pop	(0+5)
      002159 D0 06            [24]  709 	pop	(0+6)
      00215B D0 07            [24]  710 	pop	(0+7)
      00215D D0 83            [24]  711 	pop	dph
      00215F D0 82            [24]  712 	pop	dpl
      002161 D0 F0            [24]  713 	pop	b
      002163 D0 E0            [24]  714 	pop	acc
      002165 D0 21            [24]  715 	pop	bits
      002167 32               [24]  716 	reti
                                    717 ;------------------------------------------------------------
                                    718 ;Allocation info for local variables in function 'main'
                                    719 ;------------------------------------------------------------
                                    720 ;	main.c:28: void main(void)
                                    721 ;	-----------------------------------------
                                    722 ;	 function main
                                    723 ;	-----------------------------------------
      002168                        724 _main:
                                    725 ;	inc/system.h:84: SAFE_MOD = 0x55;
      002168 75 A1 55         [24]  726 	mov	_SAFE_MOD,#0x55
                                    727 ;	inc/system.h:85: SAFE_MOD = 0xAA;                              // enter safe mode
      00216B 75 A1 AA         [24]  728 	mov	_SAFE_MOD,#0xaa
                                    729 ;	inc/system.h:90: __asm__("anl _CLOCK_CFG, #0b11111000");
      00216E 53 B9 F8         [24]  730 	anl	_CLOCK_CFG, #0b11111000
                                    731 ;	inc/system.h:91: __asm__("orl _CLOCK_CFG, #0b00000110");     // 24MHz	
      002171 43 B9 06         [24]  732 	orl	_CLOCK_CFG, #0b00000110
                                    733 ;	inc/system.h:113: SAFE_MOD = 0x00;                              // terminate safe mode
      002174 75 A1 00         [24]  734 	mov	_SAFE_MOD,#0x00
                                    735 ;	main.c:31: DLY_ms(20);
      002177 90 00 14         [24]  736 	mov	dptr,#0x0014
      00217A 12 1C 22         [24]  737 	lcall	_DLY_ms
                                    738 ;	main.c:33: PIN_output(P14);
      00217D 53 92 EF         [24]  739 	anl	_P1_MOD_OC,#0xef
      002180 43 93 10         [24]  740 	orl	_P1_DIR_PU,#0x10
                                    741 ;	main.c:34: PIN_output(P15);
      002183 53 92 DF         [24]  742 	anl	_P1_MOD_OC,#0xdf
      002186 43 93 20         [24]  743 	orl	_P1_DIR_PU,#0x20
                                    744 ;	main.c:35: PIN_output(P16);
      002189 53 92 BF         [24]  745 	anl	_P1_MOD_OC,#0xbf
      00218C 43 93 40         [24]  746 	orl	_P1_DIR_PU,#0x40
                                    747 ;	main.c:36: PIN_output(P17);
      00218F 53 92 7F         [24]  748 	anl	_P1_MOD_OC,#0x7f
      002192 43 93 80         [24]  749 	orl	_P1_DIR_PU,#0x80
                                    750 ;	main.c:37: PIN_low(P14);
                                    751 ;	assignBit
      002195 C2 94            [12]  752 	clr	_PP14
                                    753 ;	main.c:39: CDC_init();
      002197 12 1D C1         [24]  754 	lcall	_USB_init
                                    755 ;	main.c:41: DLY_ms(20);
      00219A 90 00 14         [24]  756 	mov	dptr,#0x0014
      00219D 12 1C 22         [24]  757 	lcall	_DLY_ms
                                    758 ;	main.c:46: ISP();
                                    759 ;	main.c:60: }
      0021A0 02 00 B6         [24]  760 	ljmp	_ISP
                                    761 	.area CSEG    (CODE)
                                    762 	.area CONST   (CODE)
                                    763 	.area XINIT   (CODE)
