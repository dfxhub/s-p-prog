      ...
      000000                        495 	.ds 8
                                    ...
                                    557 	.area CSEG    (CODE)
                                    558 ;------------------------------------------------------------
                                    559 ;Allocation info for local variables in function 'DLY_us'
                                    560 ;------------------------------------------------------------
                                    561 ;n                         Allocated to registers 
                                    562 ;------------------------------------------------------------
                                    563 ;	lib\delay.c:10: void DLY_us(uint16_t n) {           // delay in us
                                    564 ;	-----------------------------------------
                                    565 ;	 function DLY_us
                                    566 ;	-----------------------------------------
      001C04                        567 _DLY_us:
                           ...
                           000001   574 	ar1 = 0x01
                           000000   575 	ar0 = 0x00
      001C04 AE 82            [24]  576 	mov	r6,dpl
      001C06 AF 83            [24]  577 	mov	r7,dph
                                    578 ;	lib\delay.c:23: while(n) {                        // total = 12~13 Fsys cycles, 1uS @Fsys=12MHz
      001C08                        579 00101$:
      001C08 EE               [12]  580 	mov	a,r6
      001C09 4F               [12]  581 	orl	a,r7
      001C0A 60 15            [24]  582 	jz	00104$
                                    583 ;	lib\delay.c:24: __asm__("inc _SAFE_MOD");       // 2 Fsys cycles, for higher Fsys, add operation here
      001C0C 05 A1            [12]  584 	inc	_SAFE_MOD
                                    585 ;	lib\delay.c:27: __asm__("inc _SAFE_MOD");
      001C0E 05 A1            [12]  586 	inc	_SAFE_MOD
                                    587 ;	lib\delay.c:30: __asm__("inc _SAFE_MOD");
      001C10 05 A1            [12]  588 	inc	_SAFE_MOD
                                    589 ;	lib\delay.c:33: __asm__("inc _SAFE_MOD");
      001C12 05 A1            [12]  590 	inc	_SAFE_MOD
                                    591 ;	lib\delay.c:36: __asm__("inc _SAFE_MOD");
      001C14 05 A1            [12]  592 	inc	_SAFE_MOD
                                    593 ;	lib\delay.c:39: __asm__("inc _SAFE_MOD");
      001C16 05 A1            [12]  594 	inc	_SAFE_MOD
                                    595 ;	lib\delay.c:42: __asm__("inc _SAFE_MOD");
      001C18 05 A1            [12]  596 	inc	_SAFE_MOD
                                    597 ;	lib\delay.c:57: --n;
      001C1A 1E               [12]  598 	dec	r6
      001C1B BE FF 01         [24]  599 	cjne	r6,#0xff,00116$
      001C1E 1F               [12]  600 	dec	r7
      001C1F                        601 00116$:
      001C1F 80 E7            [24]  602 	sjmp	00101$
      001C21                        603 00104$:
                                    604 ;	lib\delay.c:59: }
      001C21 22               [24]  605 	ret
                                    606 ;------------------------------------------------------------
                                    607 ;Allocation info for local variables in function 'DLY_ms'
                                    608 ;------------------------------------------------------------
                                    609 ;n                         Allocated to registers 
                                    610 ;------------------------------------------------------------
                                    611 ;	lib\delay.c:64: void DLY_ms(uint16_t n) {           // delay in ms
                                    612 ;	-----------------------------------------
                                    613 ;	 function DLY_ms
                                    614 ;	-----------------------------------------
      001C22                        615 _DLY_ms:
      001C22 AE 82            [24]  616 	mov	r6,dpl
      001C24 AF 83            [24]  617 	mov	r7,dph
                                    618 ;	lib\delay.c:65: while(n) {
      001C26                        619 00107$:
      001C26 EE               [12]  620 	mov	a,r6
      001C27 4F               [12]  621 	orl	a,r7
      001C28 60 11            [24]  622 	jz	00110$
                                    623 ;	lib\delay.c:66: while(!(TKEY_CTRL & bTKC_IF));
      001C2A                        624 00101$:
      001C2A E5 C3            [12]  625 	mov	a,_TKEY_CTRL
      001C2C 30 E7 FB         [24]  626 	jnb	acc.7,00101$
                                    627 ;	lib\delay.c:67: while(TKEY_CTRL & bTKC_IF);
      001C2F                        628 00104$:
      001C2F E5 C3            [12]  629 	mov	a,_TKEY_CTRL
      001C31 20 E7 FB         [24]  630 	jb	acc.7,00104$
                                    631 ;	lib\delay.c:68: --n;
      001C34 1E               [12]  632 	dec	r6
      001C35 BE FF 01         [24]  633 	cjne	r6,#0xff,00132$
      001C38 1F               [12]  634 	dec	r7
      001C39                        635 00132$:
      001C39 80 EB            [24]  636 	sjmp	00107$
      001C3B                        637 00110$:
                                    638 ;	lib\delay.c:70: }
      001C3B 22               [24]  639 	ret
                                    640 	.area CSEG    (CODE)
                                    641 	.area CONST   (CODE)
                                    642 	.area XINIT   (CODE)
